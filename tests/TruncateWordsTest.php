...
final class TruncateWordsTest extends TestCase
{
    ...
    public function testArabic(): void
    {
        ...
        $txt = TruncateWords::truncateWords($txt, 93);
        ...
        $txt = TruncateWords::truncateWords($txt, 28);
    ...
    {
        $txt = '道可道非常道，名可名非常名。';
        $txt = TruncateWords::truncateWords($txt, 5);
        self::assertSame('道可道非常', $txt);

        $txt = '吾輩は猫で∂る（夏ｭﾚ漱⽯）：吾輩は猫で∂る';
        $txt = TruncateWords::truncateWords($txt, 7);
    ...
    public function testKana(): void
    {
        ...
        $txt = TruncateWords::truncateWords($txt, 12);
    ...
    public function testRussian(): void
    {
        ...
        $txt = TruncateWords::truncateWords($txt, 65);
